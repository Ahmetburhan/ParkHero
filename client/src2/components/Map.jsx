    ...
    render() {
        ...
        return (
            <div>
                ...
                <Iframe getCoords={this.props.getCoordsMap} url={`https://www.google.com/maps/embed/v1/search?key=AIzaSyCcmHoNv1RH34LAlFdaJnic_8xVset4KX0&q=parking+garages+in+${this.state.address}`}
                    width="100%"
                    height="300px"
                    id="myId"
